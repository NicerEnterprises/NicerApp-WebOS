...
//debugger;
        ...
        if (unread < 100) {
            ...
            if (unread > 10) na1.displayNewNewsItems();
            return false;
            /*
    ...
    */
    ...
    displayNewNewsItems : function () {
        ...
        while (c.tries < randomValue) {
            //console.log ('x1:'+randomValue+':'+c.tries, na1.displayNewNewsItem());
    ...
    displayNews_full : function (prefix) {
        ...
        if (prefix=='' && maxY > container.height()-20) { full = true; }
    ...
    displayNews_formatItem : function (it, prefix) {
        ...
        w1 = $('#siteContent .vividDialogContent').width()-20,
    ...
    //h = '100%';
        ...
        $(el).css({height:'fit-content',maxHeight:h});
        $('.newsApp__item__desc',el).css({maxHeight:h-hA-50});
        $('.newsApp__item__contentContainer',el).css({maxHeight:h-hA-40});

        $(el).find('div, p, span').not('.vividScrollpane, .newsApp__item__outer__bg, .newsApp__item__outer__bgFile1, .newsApp__item__outer__bgFile2, .newsApp__item__noPaint').each(function(idx,el2) {
