na.an = na.analytics = {
    ...
    load_date : function(date) {
        ...
        url = '/NicerAppWebOS/apps/nicer.app/app.2D.analytics/ajax_load_index.php',
        ac = {
            type : 'GET',
            url : url,
            data : {
    ...
    logEvent : function (evt) {
        ...
        if (!na.site.globals.naLAN) $.ajax(ac);
    ...
    geoIP : function (evt, IP) {
        ...
        ajaxCmd = {
            url : '/NicerAppWebOS/apps/nicer.app/app.2D.analytics/geoIP.html.php',
            type : 'GET',
            data : dataToServer,
            async : true,
