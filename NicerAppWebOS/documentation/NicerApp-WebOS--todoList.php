...
?>
    ...
    <ol class="todoList">
        ...
        <li class="todoList releaseDate"><div>(DONE) (2022 Nov 7th) : the emerging of <a href="https://said.by" class="noPushState noVividText" target="saidDotBy" style="margin:0 !important;">https://said.by</a> as an online blogging platform for end-users in the allowed zone (as defined by the <a href="https://www.facebook.com/rene.veerman.90/posts/pfbid0J3hHkQf4mJtTU1hTfp2vRtSMjmQsypmGDtz7z5o3AEdsdXJLkjMckLVXtYj6bNjBl" class="noPushState noVividText" target="saidDotBy_blockList" style="margin:0 !important;">block list of the news app on https://nicer.app)</a>.</li>

        <li class="todoList releaseDate"><div>(DONE) (2022 Nov 8th) Release 'Stable' and 'Development' branches on <a href="https://github.com/NicerEnterprises" class="noPushState" target="githubNA">github.com</a> for the NicerApp WebOS 5.0 repository.</div></li>

        <li class="todoList"><div>(2022-Nov to 2023-Feb-10) Version 6.0 : upgrade the na.desktop component to it's next major version (a complete rewrite, but one that enhances the old feature set by a significant degree.<br/>This version will allow for dialogs to be repositioned and resized by drag and drop.</div></li>
...
NOT RIGHT:
na.vividUI.loadTemplates = function (vividUIcomponentType) { ... }; // vividUIcomponentType == 'button' or 'dialog' or 'menu'.
na.vividUI.buttons.templates = {
    "keyA___keyB1__keyC_varCAname__keyD_varDAname" : {
...
SAME:
na.vividUI.buttons.templates = {
    "{'findCommand':{'dataSetID':'couchdbDatabaseName','dataSubsetID':{'keyA' : 1, 'keyB' : 'abc21.2'}}}" : {
        "code" : "na.vividUI.buttons.someButtonClassName",
        "preRendering" : { ... }
        "rendered" : { ... }
    }
...
note that we're storing the templates in a couchdb database with a specific suffix (combined with a prefix of a domain name), instead of as files on disk, although the db_init.php script would, via the PHP database connector business logic code, install all basic templates into the database.<br/>
we store them into the database now already to make it easier later on to write a Theme Editor tab page for copied templates from a templates folder into the database.<br/>
<br/>
and what we do for buttons here, we can also do for dialogs and menus.
        ...
        <li class="todoList"><div>(2023-Jan-Feb) Integration of payment platforms (as plugins) for paypal.com, creditcards, and the Dutch banking system iDeal.</div></li>

        <li class="todoList"><div>(2023-Jan-Feb) Webshop functionality</div></li>
...
<pre>
    {
        ...
        "permissions" : "find,see,view,edit,archive,delete"
                ...
                <li><div>(2022-Nov) Build a vividDialog #siteToolbarPermissions and list that in /NicerAppWebOS/na.desktop-5.y.z.js, for '/NicerAppWebOS/apps/NicerAppWebOS/applications/2D/dataSetsExplorer' to specify 'permissions' on any given 'dataSubSet' ('table row' in SQL, 'database document' in couchdb) (and especially the Content Management System, Blogging System, related dataSets), a feature that is lacking in the base layers of any database server system and thus left to business logic code supplied by me.<br/>
                </div></li>

                <li><div>(2022-Nov) Enforce the permissions system in all scripts that edit or display dataSubSets (table rows/database documents).
                <ol class="todoList_l2">
                    <li><div>(2022-Nov) Modify the editDataSubSet() functions in /NicerAppWebOS/logic.databases/generalizedDatabasesAPI-1.0.0/class.database_API.php and /NicerAppWebOS/logic.databases/generalizedDatabasesAPI-1.0.0/connectors/class.couchdb-3.2.2_1.0.1.php to check for permissions.<br/>
                    Route all calls to edit the data through this function.
                    </div></li>

                    <li><div>(2022-Nov) Add functions viewDataSubSet() in /NicerAppWebOS/logic.databases/generalizedDatabasesAPI-1.0.0/class.database_API.php and /NicerAppWebOS/logic.databases/generalizedDatabasesAPI-1.0.0/connectors/class.couchdb-3.2.2_1.0.1.php and let it check for permissions at the 'connector' level.<br/>
                    Route all calls to view such data through this function.</div></li>
                </ol>
                </div></li>

                <li><div>(2022-Nov) for the dataSetsExplorer, move the contents of #siteToolbarLeft into the new #siteToolbarExplorer, and build a new vividDialog #siteToolbarShortcuts and list both in /NicerAppWebOS/na.desktop-5.y.z.js, fill it with a jstree component and allow drag and drop between #siteToolbarExplorer for the blogEditor/dataSetsExplorer and #siteToolbarShortcuts.</div></li>

                <li><div>(2022-Dec) Allow automatic reloading of the blogging interface, to support multiple people editing a single set of documents/pages (dataSubSets) in parallel.<br/>
                Allow access to the version history of dataSubSets.<br/>
                </div></li>
            </ol>
        </div></li>

        <li class="todoList"><div>(2022-Dec) Version 5.1 : Restore the automatic retrieval of new backgrounds download routines for nicerapp via free to use methods of delivery at Google image search and (TODO :)Bing image search.</div></li>

        <li class="todoList"><div>(2022-Dec) Version 5.2 : Upgrade the way themes and specificities work.<br/>
            <ol class="todoList_l1">
        ...
        <li class="todoList"><div>(2023-Jan-Feb) Version 5.3 : Upgrade the Theme Editor : 2 new tab pages :<br/>
            <ol class="todoList_l1">
        ...
        <li class="todoList"><div>(2023-Jan-Mar) Version 5.3 : Start work on a custom HTML WYSIWYG rich-text editor component of my own, since tinymce is not compatible with CSS animations or editing of any CSS properties, or the addition of js components to a given HTML selector.<br/>
            <ol class="todoList_l1">
        ...
        <li class="todoList"><div>(starting 2023-Feb/Mar) Upgrade the news app and vividDialog : add siteToolbarLeft functionality :<br/>
            <ol class="todoList_l1">
        ...
        <li class="todoList"><div>(2023-Jan-Feb) Figure out a way to store the width and height of each background found in the filesystem in the output of .../NicerAppWebOS/domainConfigs/DOMAIN.TLD/ajax_backgrounds_recursive.php and .../NicerAppWebOS/domainConfigs/DOMAIN.TLD/ajax_backgrounds.php.<br/>
