...
na.site = {
    ...
    onload : function (evt) {
        ...
        na.site.settings.defaultStatusMsg = (
            ...
            ? '<table style=""><tr><td><a href="/" class="bright" style="padding:0;text-shadow:0px 0px 5px rgba(0,0,0,0.8);">'+na.site.globals.domain+'</a> only uses cookies for remembering user settings.</td>'
        ...
        loadContent_getContent_do = function () {
            ...
            ac = {
                ...
                error : function (xhr, textStatus, errorThrown) {
                    ...
                    if (xhr.status===302) {
                        var msg = na.m.log (11, fncn+' : REDIRECTED (HTTP 302) -- probably an seoValue URL -- now calling na.site.loadContent_displayContent(eventData,  xhr.responseText, textStatus, xhr);', false);
